...
void caractScan(char *val){
    /* On crée un char de taille 2 car l'on veut récupérer que 1 caractére et \0  */
    char* valChar = NULL;
    int sizeValChar = sizeof(char)*1+1;
...
void doubleScan(double *val){
    /* On crée un char de taille la taille maximal du plus grand des int : DBL_MAX  */
    char* valChar = NULL;
